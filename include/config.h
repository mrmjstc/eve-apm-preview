...
public:
    ...
    void setCharacterBorderColor(const QString& characterName, const QColor& color);
    ...
    static constexpr const char* KEY_GLOBAL_LAST_USED_PROFILE = "global/lastUsedProfile";
    static constexpr const char* DEFAULT_GLOBAL_LAST_USED_PROFILE = "default";
    static constexpr const char* KEY_UI_SKIP_PROFILE_SWITCH_CONFIRMATION = "ui/skipProfileSwitchConfirmation";
    ...
    static constexpr int DEFAULT_THUMBNAIL_REFRESH_INTERVAL = 1000;
    ...
    static inline QStringList DEFAULT_COMBAT_MESSAGE_EVENT_TYPES() { return QStringList{ "fleet_invite", "follow_warp", "regroup", "compression", "mining_started", "mining_stopped" }; }
...
private:
    ...
    mutable int m_cachedRefreshInterval;
    ...
    static constexpr const char* KEY_UI_HIGHLIGHT_ACTIVE = "ui/highlightActiveWindow";
    static constexpr const char* KEY_UI_HIGHLIGHT_COLOR = "ui/highlightColor";
    static constexpr const char* KEY_UI_HIGHLIGHT_BORDER_WIDTH = "ui/highlightBorderWidth";
    ...
    static constexpr const char* KEY_UI_HIDE_ACTIVE_THUMBNAIL = "ui/hideActiveClientThumbnail";
    static constexpr const char* KEY_THUMBNAIL_REFRESH_INTERVAL = "thumbnail/refreshInterval";
    ...
    static constexpr const char* KEY_POSITION_ENABLE_SNAPPING = "position/enableSnapping";
    static constexpr const char* KEY_POSITION_SNAP_DISTANCE = "position/snapDistance";
    ...
    static constexpr const char* KEY_HOTKEY_ONLY_WHEN_EVE_FOCUSED = "hotkey/onlyWhenEVEFocused";

    static constexpr const char* KEY_OVERLAY_SHOW_CHARACTER = "overlay/showCharacterName";
    static constexpr const char* KEY_OVERLAY_CHARACTER_COLOR = "overlay/characterNameColor";
    static constexpr const char* KEY_OVERLAY_CHARACTER_POSITION = "overlay/characterNamePosition";
    static constexpr const char* KEY_OVERLAY_CHARACTER_FONT = "overlay/characterNameFont";
    static constexpr const char* KEY_OVERLAY_SHOW_SYSTEM = "overlay/showSystemName";
    static constexpr const char* KEY_OVERLAY_SYSTEM_COLOR = "overlay/systemNameColor";
    static constexpr const char* KEY_OVERLAY_SYSTEM_POSITION = "overlay/systemNamePosition";
    static constexpr const char* KEY_OVERLAY_SYSTEM_FONT = "overlay/systemNameFont";
    static constexpr const char* KEY_OVERLAY_SHOW_BACKGROUND = "overlay/showBackground";
    static constexpr const char* KEY_OVERLAY_BACKGROUND_COLOR = "overlay/backgroundColor";
    static constexpr const char* KEY_OVERLAY_BACKGROUND_OPACITY = "overlay/backgroundOpacity";
    ...
    static constexpr const char* KEY_COMBAT_ENABLED_EVENT_TYPES = "combatMessages/enabledEventTypes";
    
    static inline QString combatEventColorKey(const QString& eventType) { return QString("combatMessages/eventColors/%1").arg(eventType); }
    static inline QString combatEventDurationKey(const QString& eventType) { return QString("combatMessages/eventDurations/%1").arg(eventType); }
    static inline QString combatEventBorderHighlightKey(const QString& eventType) { return QString("combatMessages/borderHighlights/%1").arg(eventType); }
    ...
    static inline QMap<QString, QString> DEFAULT_EVENT_COLORS() {
        return QMap<QString, QString>{
            ...
            {"regroup", "#FF8C42"},
            {"compression", "#7FFF00"},
            {"mining_started", "#FFD700"},
            {"mining_stopped", "#FF6B6B"}
        };
    }
    
    static constexpr const char* KEY_MINING_TIMEOUT_SECONDS = "miningMode/timeoutSeconds";
};
