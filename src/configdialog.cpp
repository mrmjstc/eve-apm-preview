    ...
    , m_notLoggedInReferenceThumbnail(nullptr)
{
    ...
    if (m_profileHotkeyCapture) {
        ...
        if (!hotkey.isEmpty()) {
            QMap<QString, QPair<int, int>> allHotkeys = Config::instance().getAllProfileHotkeys();
...
void ConfigDialog::setupUI()
{
    ...
    createCategoryList();
    connect(m_categoryList, &QListWidget::currentRowChanged, this, &ConfigDialog::onCategoryChanged);
    ...
    connect(m_globalSearchBox, &QLineEdit::textChanged, this, &ConfigDialog::onGlobalSearchChanged);
    ...
    connect(m_testOverlaysButton, &QPushButton::clicked, this, &ConfigDialog::onTestOverlays);
...
void ConfigDialog::createAppearancePage()
{
    ...
    tagWidget(sizeSection, {"thumbnail", "size", "width", "height", "opacity", "transparent", "dimension", "pixel"});
    ...
    QLabel *sizeInfoLabel = new QLabel("Adjust the size and opacity of thumbnail windows.");
    ...
    m_aspectRatio16_9Button->setStyleSheet(StyleSheet::getAspectRatioButtonStyleSheet());
    ...
    connect(m_aspectRatio16_9Button, &QPushButton::clicked, this, &ConfigDialog::onAspectRatio16_9);
    connect(m_aspectRatio21_9Button, &QPushButton::clicked, this, &ConfigDialog::onAspectRatio21_9);
    connect(m_aspectRatio4_3Button, &QPushButton::clicked, this, &ConfigDialog::onAspectRatio4_3);
    ...
    tagWidget(highlightSection, {"highlight", "active", "window", "border", "color", "cyan", "frame", "outline"});
    ...
    QLabel *highlightInfoLabel = new QLabel("Highlight the active EVE client window with a colored border.");
    ...
    QVBoxLayout *thumbnailVisibilitySectionLayout = new QVBoxLayout(thumbnailVisibilitySection);
    thumbnailVisibilitySectionLayout->setContentsMargins(16, 12, 16, 12);
    thumbnailVisibilitySectionLayout->setSpacing(10);
    
    tagWidget(thumbnailVisibilitySection, {"hide", "active", "thumbnail", "visibility", "focus", "focused", "client", "window", "always", "top", "preview"});
    
    QLabel *thumbnailVisibilityHeader = new QLabel("Thumbnail Visibility");
    thumbnailVisibilityHeader->setStyleSheet(StyleSheet::getSectionHeaderStyleSheet());
    thumbnailVisibilitySectionLayout->addWidget(thumbnailVisibilityHeader);
    
    QLabel *thumbnailVisibilityInfoLabel = new QLabel("Control the visibility and behavior of thumbnail windows.");
    thumbnailVisibilityInfoLabel->setStyleSheet(StyleSheet::getInfoLabelStyleSheet());
    ...
    m_hideActiveClientThumbnailCheck = new QCheckBox("Hide active client thumbnail");
    m_hideActiveClientThumbnailCheck->setStyleSheet(StyleSheet::getCheckBoxStyleSheet());
    ...
    tagWidget(charColorsSection, {"character", "highlight", "color", "custom", "border", "individual", "per-character"});
    ...
    QLabel *charColorsInfoTop = new QLabel("Override the default highlight color for specific characters. When a character-specific color is set, it will be used instead of the global highlight color above.");
    ...
    m_characterColorsTable->setHorizontalHeaderLabels({"Character Name", "Highlight Color", ""});
    m_characterColorsTable->horizontalHeader()->setStretchLastSection(false);
    m_characterColorsTable->horizontalHeader()->setSectionResizeMode(0, QHeaderView::Stretch);
    m_characterColorsTable->horizontalHeader()->setSectionResizeMode(1, QHeaderView::Fixed);
    m_characterColorsTable->horizontalHeader()->setSectionResizeMode(2, QHeaderView::Fixed);
    ...
    m_populateCharacterColorsButton = new QPushButton("Populate from Open Clients");
    ...
    connect(m_addCharacterColorButton, &QPushButton::clicked, this, &ConfigDialog::onAddCharacterColor);
    connect(m_populateCharacterColorsButton, &QPushButton::clicked, this, &ConfigDialog::onPopulateCharacterColors);
    connect(m_assignUniqueColorsButton, &QPushButton::clicked, this, &ConfigDialog::onAssignUniqueColors);
    ...
    tagWidget(overlaysSection, {"overlay", "character", "name", "system", "font", "background", "text", "position", "color", "opacity"});
    ...
    QLabel *overlaysInfoTop = new QLabel("Configure text overlays displayed on thumbnail windows.");
    ...
    connect(m_characterNameFontButton, &QPushButton::clicked, this, [this]() {
        bool ok;
        QFont font = QFontDialog::getFont(&ok, Config::instance().characterNameFont(), this, "Select Character Name Font");
        if (ok) {
    ...
    connect(m_systemNameFontButton, &QPushButton::clicked, this, [this]() {
        bool ok;
        QFont font = QFontDialog::getFont(&ok, Config::instance().systemNameFont(), this, "Select System Name Font");
        if (ok) {
    ...
    connect(resetButton, &QPushButton::clicked, this, &ConfigDialog::onResetAppearanceDefaults);
...
void ConfigDialog::createHotkeysPage()
{
    ...
    tagWidget(suspendSection, {"suspend", "toggle", "disable", "hotkey", "pause", "temporary"});
    ...
    QLabel *suspendInfoLabel = new QLabel("Press this hotkey to temporarily disable all other hotkeys.");
    ...
    m_suspendHotkeyCapture->setStyleSheet(StyleSheet::getHotkeyCaptureStandaloneStyleSheet());
    ...
    connect(clearSuspendButton, &QPushButton::clicked, [this]() {
    ...
    tagWidget(closeAllSection, {"close", "all", "clients", "exit", "quit", "shutdown", "hotkey", "keyboard", "shortcut"});
    ...
    QLabel *closeAllInfoLabel = new QLabel("Hotkey to close all EVE client windows at once.");
    ...
    m_closeAllClientsCapture->setStyleSheet(StyleSheet::getHotkeyCaptureStandaloneStyleSheet());
    ...
    connect(clearCloseAllButton, &QPushButton::clicked, [this]() {
    ...
    tagWidget(charHotkeysSection, {"character", "hotkey", "switch", "activate", "client", "keyboard", "shortcut", "f1", "f2", "f3"});
    ...
    QLabel *charInfoLabel = new QLabel("Assign hotkeys to instantly switch to specific character windows.");
    ...
    m_characterHotkeysTable->setHorizontalHeaderLabels({"Character Name", "Hotkey", ""});
    m_characterHotkeysTable->horizontalHeader()->setSectionResizeMode(0, QHeaderView::Stretch);
    m_characterHotkeysTable->horizontalHeader()->setSectionResizeMode(1, QHeaderView::Fixed);
    m_characterHotkeysTable->horizontalHeader()->setSectionResizeMode(2, QHeaderView::Fixed);
    ...
    connect(m_addCharacterButton, &QPushButton::clicked, this, &ConfigDialog::onAddCharacterHotkey);
    connect(m_populateCharactersButton, &QPushButton::clicked, this, &ConfigDialog::onPopulateFromOpenWindows);
    ...
    tagWidget(cycleGroupsSection, {"cycle", "group", "forward", "backward", "rotate", "tab", "ctrl", "shift"});
    ...
    QLabel *cycleInfoLabel = new QLabel("Create groups of characters to cycle through with forward and backward hotkeys.");
    ...
    m_cycleGroupsTable->setHorizontalHeaderLabels({"Group Name", "Characters", "Forward Key", "Backward Key", "Inc. Not Logged In", "Don't Loop", ""});
    m_cycleGroupsTable->horizontalHeader()->setSectionResizeMode(0, QHeaderView::Interactive);
    m_cycleGroupsTable->horizontalHeader()->setSectionResizeMode(1, QHeaderView::Stretch);
    m_cycleGroupsTable->horizontalHeader()->setSectionResizeMode(2, QHeaderView::Fixed);
    m_cycleGroupsTable->horizontalHeader()->setSectionResizeMode(3, QHeaderView::Fixed);
    ...
    connect(m_addGroupButton, &QPushButton::clicked, this, &ConfigDialog::onAddCycleGroup);
    ...
    tagWidget(notLoggedInSection, {"not logged in", "login", "cycle", "not-logged-in", "forward", "backward"});
    ...
    QLabel *notLoggedInInfoLabel = new QLabel("Dedicated hotkeys to cycle through EVE clients that are not yet logged in.");
    ...
    m_notLoggedInForwardCapture->setStyleSheet(StyleSheet::getHotkeyCaptureStandaloneStyleSheet());
    ...
    connect(clearNotLoggedInForwardButton, &QPushButton::clicked, [this]() {
    ...
    m_notLoggedInBackwardCapture->setStyleSheet(StyleSheet::getHotkeyCaptureStandaloneStyleSheet());
    ...
    connect(clearNotLoggedInBackwardButton, &QPushButton::clicked, [this]() {
    ...
    notLoggedInGrid->addWidget(clearNotLoggedInForwardButton, 0, 2, Qt::AlignLeft);
    notLoggedInGrid->addWidget(backwardLabel, 1, 0, Qt::AlignLeft);
    notLoggedInGrid->addWidget(m_notLoggedInBackwardCapture, 1, 1);
    notLoggedInGrid->addWidget(clearNotLoggedInBackwardButton, 1, 2, Qt::AlignLeft);
    ...
    tagWidget(nonEVESection, {"non-eve", "non eve", "cycle", "other", "applications", "forward", "backward"});
    ...
    QLabel *nonEVEInfoLabel = new QLabel("Dedicated hotkeys to cycle through non-EVE applications (other programs added to Extra Previews).");
    ...
    m_nonEVEForwardCapture->setStyleSheet(StyleSheet::getHotkeyCaptureStandaloneStyleSheet());
    ...
    connect(clearNonEVEForwardButton, &QPushButton::clicked, [this]() {
    ...
    m_nonEVEBackwardCapture->setStyleSheet(StyleSheet::getHotkeyCaptureStandaloneStyleSheet());
    ...
    connect(clearNonEVEBackwardButton, &QPushButton::clicked, [this]() {
    ...
    tagWidget(wildcardSection, {"wildcard", "hotkey", "modifier", "ctrl", "alt", "shift", "extra", "additional"});
    ...
    QLabel *wildcardInfoLabel = new QLabel(
        "When enabled, hotkeys will work even when additional modifier keys are pressed. "
        "For example, if a hotkey is set to F22, it will also trigger when pressing Ctrl+F22, Alt+F22, etc."
    );
    ...
    tagWidget(eveFocusSection, {"eve", "focus", "hotkey", "active", "window", "client", "only"});
    ...
    QLabel *eveFocusInfoLabel = new QLabel(
        "When enabled, hotkeys will only work when an EVE client window is focused. "
        "This prevents accidental window switching when using other applications."
    );
    ...
    m_hotkeysOnlyWhenEVEFocusedCheck = new QCheckBox("Only process hotkeys when EVE client is focused");
    m_hotkeysOnlyWhenEVEFocusedCheck->setStyleSheet(StyleSheet::getCheckBoxStyleSheet());
    ...
    QPushButton *resetButton = new QPushButton("Reset to Defaults");
    resetButton->setStyleSheet(StyleSheet::getResetButtonStyleSheet());
    connect(resetButton, &QPushButton::clicked, this, &ConfigDialog::onResetHotkeysDefaults);
    resetLayout->addWidget(resetButton);
    layout->addLayout(resetLayout);
...
void ConfigDialog::createBehaviorPage()
{
    ...
    m_neverMinimizeTable->horizontalHeader()->setSectionResizeMode(0, QHeaderView::Stretch);
    m_neverMinimizeTable->horizontalHeader()->setSectionResizeMode(1, QHeaderView::Fixed);
    ...
    connect(m_addNeverMinimizeButton, &QPushButton::clicked, this, &ConfigDialog::onAddNeverMinimizeCharacter);
    connect(m_populateNeverMinimizeButton, &QPushButton::clicked, this, &ConfigDialog::onPopulateNeverMinimize);
    ...
    tagWidget(positionSection, {"position", "remember", "snap", "snapping", "distance", "lock", "locked", "placement", "arrange"});
    ...
    QLabel *positionInfoLabel = new QLabel("Control thumbnail placement and snapping behavior for easier organization.");
    ...
    m_preserveLogoutPositionsCheck = new QCheckBox("Preserve positions when logged out");
    m_preserveLogoutPositionsCheck->setStyleSheet(StyleSheet::getCheckBoxStyleSheet());
    ...
    tagWidget(clientFilterSection, {"client", "filter", "visibility", "not logged in", "extra", "previews", "non-eve", "application"});
    ...
    QLabel *clientFilterInfoLabel = new QLabel("Control which windows are shown as thumbnails and how they are displayed.");
    ...
    QLabel *extraPreviewsInfoLabel = new QLabel("Add other executable names to create thumbnails for. EVE Online clients (exefile.exe) are always included. Case-insensitive.");
    ...
    m_processNamesTable->setHorizontalHeaderLabels({"Additional Executable Names", ""});
    m_processNamesTable->horizontalHeader()->setSectionResizeMode(0, QHeaderView::Stretch);
    m_processNamesTable->horizontalHeader()->setSectionResizeMode(1, QHeaderView::Fixed);
    ...
    QPushButton *resetButton = new QPushButton("Reset to Defaults");
    resetButton->setStyleSheet(StyleSheet::getResetButtonStyleSheet());
    connect(resetButton, &QPushButton::clicked, this, &ConfigDialog::onResetBehaviorDefaults);
    resetLayout->addWidget(resetButton);
    layout->addLayout(resetLayout);
...
void ConfigDialog::createPerformancePage()
{
    ...
    intervalSectionLayout->setContentsMargins(16, 12, 16, 12);
    intervalSectionLayout->setSpacing(10);
    
    tagWidget(intervalSection, {"refresh", "update", "interval", "performance", "fps", "rate", "speed", "milliseconds", "ms"});
    
    QLabel *intervalHeader = new QLabel("Update Interval");
    intervalHeader->setStyleSheet(StyleSheet::getSectionHeaderStyleSheet());
    intervalSectionLayout->addWidget(intervalHeader);
    
    QLabel *intervalInfo = new QLabel(
        "Controls how often the application checks for new/closed windows and updates overlay text. "
        "Lower values detect changes faster but use slightly more CPU. Best to leave this alone."
    );
    intervalInfo->setStyleSheet(StyleSheet::getInfoLabelStyleSheet());
    intervalInfo->setWordWrap(true);
    intervalSectionLayout->addWidget(intervalInfo);
    
    QGridLayout *intervalGrid = new QGridLayout();
    intervalGrid->setSpacing(10);
    intervalGrid->setColumnMinimumWidth(0, 120);
    intervalGrid->setColumnStretch(2, 1);
    
    QLabel *refreshLabel = new QLabel("Update interval:");
    refreshLabel->setStyleSheet(StyleSheet::getLabelStyleSheet());
    m_refreshIntervalSpin = new QSpinBox();
    m_refreshIntervalSpin->setRange(100, 5000);
    m_refreshIntervalSpin->setSuffix(" ms");
    m_refreshIntervalSpin->setFixedWidth(150);
    m_refreshIntervalSpin->setStyleSheet(StyleSheet::getSpinBoxStyleSheet());
    
    intervalGrid->addWidget(refreshLabel, 0, 0, Qt::AlignLeft);
    intervalGrid->addWidget(m_refreshIntervalSpin, 0, 1);
    
    intervalSectionLayout->addLayout(intervalGrid);
    
    layout->addWidget(intervalSection);
    
    QHBoxLayout *resetLayout = new QHBoxLayout();
    resetLayout->addStretch();
    QPushButton *resetButton = new QPushButton("Reset to Defaults");
    resetButton->setStyleSheet(StyleSheet::getResetButtonStyleSheet());
    connect(resetButton, &QPushButton::clicked, this, &ConfigDialog::onResetPerformanceDefaults);
    resetLayout->addWidget(resetButton);
    layout->addLayout(resetLayout);
...
void ConfigDialog::createDataSourcesPage()
{
    ...
    tagWidget(logMonitoringSection, {"chat", "game", "log", "monitoring", "system", "character", "location", "directory", "path", "combat", "event"});
    ...
    QLabel *logInfoLabel = new QLabel(
        "Monitor EVE Online chat and game logs to automatically detect system locations and combat events. "
        "Chat logs provide character location data, while game logs contain fleet notifications and other events."
    );
    ...
    m_enableChatLogMonitoringCheck->setStyleSheet(StyleSheet::getCheckBoxStyleSheet());
    ...
    m_chatLogDirectoryEdit->setPlaceholderText("Default: " + Config::instance().getDefaultChatLogDirectory());
    
    m_chatLogBrowseButton = new QPushButton("Browse...");
    m_chatLogBrowseButton->setStyleSheet(StyleSheet::getSecondaryButtonStyleSheet());
    ...
    m_gameLogDirectoryEdit->setPlaceholderText("Default: " + Config::instance().getDefaultGameLogDirectory());
    
    m_gameLogBrowseButton = new QPushButton("Browse...");
    m_gameLogBrowseButton->setStyleSheet(StyleSheet::getSecondaryButtonStyleSheet());
    ...
    tagWidget(combatSection, {"combat", "event", "message", "notification", "fleet", "warp", "regroup", "compression"});
    ...
    QLabel *combatInfoLabel = new QLabel(
        ...
        "Messages include fleet invites, warp follows, regroups, and compression events."
    );
    ...
    connect(m_combatMessageFontButton, &QPushButton::clicked, this, [this]() {
        bool ok;
        QFont font = QFontDialog::getFont(&ok, Config::instance().combatMessageFont(), this, "Select Combat Message Font");
        if (ok) {
    ...
    auto createEventRow = [&](const QString& eventType, const QString& label, QCheckBox*& checkbox) {
        ...
        connect(colorBtn, &QPushButton::clicked, this, [this, eventType, colorBtn]() {
            QColor currentColor = Config::instance().combatEventColor(eventType);
            QColor color = QColorDialog::getColor(currentColor, this, QString("Select %1 Color").arg(eventType));
            if (color.isValid()) {
        ...
        connect(durationSpin, QOverload<int>::of(&QSpinBox::valueChanged), this, [eventType](int value) {
            Config::instance().setCombatEventDuration(eventType, value * 1000);
        });
        ...
        borderCheck->setToolTip("Show colored dashed border when this event occurs");
    ...
    createEventRow("fleet_invite", "Fleet invites", m_combatEventFleetInviteCheck);
    createEventRow("follow_warp", "Following in warp", m_combatEventFollowWarpCheck);
    createEventRow("regroup", "Regroup commands", m_combatEventRegroupCheck);
    createEventRow("compression", "Compression events", m_combatEventCompressionCheck);
    ...
    QPushButton *resetButton = new QPushButton("Reset to Defaults");
    resetButton->setStyleSheet(StyleSheet::getResetButtonStyleSheet());
    connect(resetButton, &QPushButton::clicked, this, &ConfigDialog::onResetCombatMessagesDefaults);
    resetLayout->addWidget(resetButton);
    layout->addLayout(resetLayout);
...
void ConfigDialog::setupBindings()
{
    ...
    m_bindingManager.addBinding(BindingHelpers::bindCheckBox(
        m_alwaysOnTopCheck,
        [&config]() { return config.alwaysOnTop(); },
        [&config](bool value) { config.setAlwaysOnTop(value); },
        true
    ));
    ...
    m_bindingManager.addBinding(BindingHelpers::bindCheckBox(
        ...
        [&config](bool value) { config.setRememberPositions(value); },
        true
    ));
    ...
    m_bindingManager.addBinding(BindingHelpers::bindCheckBox(
        m_enableSnappingCheck,
        [&config]() { return config.enableSnapping(); },
        [&config](bool value) { config.setEnableSnapping(value); },
        true
    ));
    
    m_bindingManager.addBinding(BindingHelpers::bindSpinBox(
        m_snapDistanceSpin,
        [&config]() { return config.snapDistance(); },
        [&config](int value) { config.setSnapDistance(value); },
        10
    ));
    ...
    m_bindingManager.addBinding(BindingHelpers::bindSpinBox(
        m_thumbnailWidthSpin,
        [&config]() { return config.thumbnailWidth(); },
        [&config](int value) { config.setThumbnailWidth(value); },
        400
    ));
    
    m_bindingManager.addBinding(BindingHelpers::bindSpinBox(
        m_thumbnailHeightSpin,
        [&config]() { return config.thumbnailHeight(); },
        [&config](int value) { config.setThumbnailHeight(value); },
        300
    ));
    ...
    m_bindingManager.addBinding(BindingHelpers::bindSpinBox(
        m_opacitySpin,
        [&config]() { return config.thumbnailOpacity(); },
        [&config](int value) { config.setThumbnailOpacity(value); },
        95
    ));
    ...
    m_bindingManager.addBinding(BindingHelpers::bindComboBox(
        ...
        [&config](int value) { config.setNotLoggedInStackMode(value); },
        0
    ));
    ...
    m_bindingManager.addBinding(BindingHelpers::bindCheckBox(
        ...
        [&config](bool value) { config.setShowNonEVEOverlay(value); },
        true
    ));
    ...
    m_bindingManager.addBinding(BindingHelpers::bindSpinBox(
        m_minimizeDelaySpin,
        [&config]() { return config.minimizeDelay(); },
        [&config](int value) { config.setMinimizeDelay(value); },
        500
    ));
    ...
    auto highlightColorBinding = BindingHelpers::bindColorButton(
        ...
        [&config]() { return config.highlightColor(); },
    ...
    m_bindingManager.addBinding(BindingHelpers::bindSpinBox(
        ...
        [&config](int value) { config.setHighlightBorderWidth(value); },
        3
    ));
    ...
    m_bindingManager.addBinding(BindingHelpers::bindCheckBox(
        ...
        [&config](bool value) { config.setShowCharacterName(value); },
        true
    ));
    ...
    m_bindingManager.addBinding(BindingHelpers::bindComboBox(
        ...
        [&config](int value) { config.setCharacterNamePosition(value); },
        0
    ));
    
    
    m_bindingManager.addBinding(BindingHelpers::bindCheckBox(
        m_showSystemNameCheck,
        [&config]() { return config.showSystemName(); },
        [&config](bool value) { config.setShowSystemName(value); },
        true
    ));
    
    auto sysColorBinding = BindingHelpers::bindColorButton(
        m_systemNameColorButton,
        [&config]() { return config.systemNameColor(); },
    ...
    m_bindingManager.addBinding(BindingHelpers::bindComboBox(
        ...
        [&config](int value) { config.setSystemNamePosition(value); },
        0
    ));
    ...
    m_bindingManager.addBinding(BindingHelpers::bindCheckBox(
        ...
        [&config](bool value) { config.setShowOverlayBackground(value); },
        true
    ));
    ...
    auto bgColorBinding = BindingHelpers::bindColorButton(
        ...
        [&config](const QColor& color) { config.setOverlayBackgroundColor(color); },
        QColor(0, 0, 0, 180),
        [this](QPushButton* btn, const QColor& color) {
    ...
    m_bindingManager.addBinding(BindingHelpers::bindSpinBox(
        ...
        [&config](int value) { config.setOverlayBackgroundOpacity(value); },
        70
    ));
    
    
    m_bindingManager.addBinding(BindingHelpers::bindStringListTable(
        m_neverMinimizeTable,
        0,  
        [&config]() { return config.neverMinimizeCharacters(); },
        [&config](const QStringList& list) { config.setNeverMinimizeCharacters(list); },
        QStringList()  
    ));
    ...
    m_bindingManager.addBinding(BindingHelpers::bindStringListTable(
        m_processNamesTable,
        0,  
        [&config]() { return config.processNames(); },
    ...
    m_bindingManager.addBinding(BindingHelpers::bindCharacterColorTable(
        ...
        [this](QPushButton* button) {
            connect(button, &QPushButton::clicked, this, &ConfigDialog::onCharacterColorButtonClicked);
        }
    ));
    ...
    if (hotkeyMgr) {
        m_bindingManager.addBinding(BindingHelpers::bindCharacterHotkeyTable(
            ...
            [hotkeyMgr](const QHash<QString, HotkeyBinding>& hotkeys) {
                QHash<QString, HotkeyBinding> existing = hotkeyMgr->getAllCharacterHotkeys();
        ...
        m_bindingManager.addBinding(BindingHelpers::bindCycleGroupTable(
            ...
            [this](QPushButton* button) {
                connect(button, &QPushButton::clicked, this, &ConfigDialog::onEditCycleGroupCharacters);
            }
        ));
        ...
        m_bindingManager.addBinding(BindingHelpers::bindHotkeyCapture(
            ...
            [hotkeyMgr](const HotkeyBinding& hk) { hotkeyMgr->setSuspendHotkey(hk); },
        ...
        m_bindingManager.addBinding(BindingHelpers::bindHotkeyCapture(
            ...
            [hotkeyMgr](const HotkeyBinding& hk) { 
                hotkeyMgr->setNotLoggedInCycleHotkeys(hk, hotkeyMgr->getNotLoggedInBackwardHotkey());
            },
            HotkeyBinding(0, false, false, false, false)  
        ));
        ...
        m_bindingManager.addBinding(BindingHelpers::bindHotkeyCapture(
            ...
            [hotkeyMgr](const HotkeyBinding& hk) { 
                hotkeyMgr->setNotLoggedInCycleHotkeys(hotkeyMgr->getNotLoggedInForwardHotkey(), hk);
            },
            HotkeyBinding(0, false, false, false, false)  
        ));
        ...
        m_bindingManager.addBinding(BindingHelpers::bindHotkeyCapture(
            ...
            [hotkeyMgr](const HotkeyBinding& hk) { 
                hotkeyMgr->setNonEVECycleHotkeys(hk, hotkeyMgr->getNonEVEBackwardHotkey());
            },
            HotkeyBinding(0, false, false, false, false)  
        ));
        ...
        m_bindingManager.addBinding(BindingHelpers::bindHotkeyCapture(
            ...
            [hotkeyMgr](const HotkeyBinding& hk) { 
                hotkeyMgr->setNonEVECycleHotkeys(hotkeyMgr->getNonEVEForwardHotkey(), hk);
            },
            HotkeyBinding(0, false, false, false, false)  
        ));
        ...
        m_bindingManager.addBinding(BindingHelpers::bindHotkeyCapture(
            ...
            [hotkeyMgr](const HotkeyBinding& hk) { hotkeyMgr->setCloseAllClientsHotkey(hk); },
            HotkeyBinding(0, false, false, false, false)  
        ));
    }
    ...
    m_bindingManager.addBinding(BindingHelpers::bindCheckBox(
        m_wildcardHotkeysCheck,
        [&config]() { return config.wildcardHotkeys(); },
    ...
    m_bindingManager.addBinding(BindingHelpers::bindCheckBox(
        ...
        [&config](bool value) { 
            config.setHotkeysOnlyWhenEVEFocused(value);
        },
        false  
    ));
    ...
    m_bindingManager.addBinding(BindingHelpers::bindCheckBox(
        ...
        [&config](bool value) { config.setShowCombatMessages(value); },
        true  
    ));
    ...
    m_bindingManager.addBinding(BindingHelpers::bindSpinBox(
        ...
        [&config](int value) { config.setFileChangeDebounceMs(value); },
        200
    ));
    ...
    m_bindingManager.addBinding(BindingHelpers::bindComboBox(
        ...
        [&config](int value) { config.setCombatMessagePosition(value); },
        3  
    ));
    ...
    m_bindingManager.addBinding(BindingHelpers::bindSpinBox(
        ...
        [&config](int value) { config.setMiningTimeoutSeconds(value); },
        true
    ));
...
void ConfigDialog::loadSettings()
{
    ...
    for (auto it = m_eventColorButtons.constBegin(); it != m_eventColorButtons.constEnd(); ++it) {
        QString eventType = it.key();
        QPushButton* colorBtn = it.value();
        updateColorButton(colorBtn, config.combatEventColor(eventType));
    }
    
    for (auto it = m_eventDurationSpins.constBegin(); it != m_eventDurationSpins.constEnd(); ++it) {
        QString eventType = it.key();
        QSpinBox* durationSpin = it.value();
        durationSpin->setValue(config.combatEventDuration(eventType) / 1000);  
    }
    
    for (auto it = m_eventBorderCheckBoxes.constBegin(); it != m_eventBorderCheckBoxes.constEnd(); ++it) {
        QString eventType = it.key();
...
{
    if (!m_testThumbnail) {
        m_testThumbnail = new ThumbnailWidget(quintptr(0), "Test Window - Preview", nullptr);
    ...
    if (targetColor) {
        ...
        if (color.isValid()) {
            *targetColor = color;
            ...
            if (bindingBase) {
                ColorButtonBinding* colorBinding = dynamic_cast<ColorButtonBinding*>(bindingBase);
                if (colorBinding) {
...
void ConfigDialog::updateColorButton(QPushButton* button, const QColor& color)
{
    ...
    button->setStyleSheet(StyleSheet::getColorButtonStyleSheet(color.name(), textColor));
...
void ConfigDialog::onPopulateFromOpenWindows()
{
    ...
    msgBox.setInformativeText("Do you want to clear existing entries or add to them?");
    
    QPushButton *clearButton = msgBox.addButton("Clear & Replace", QMessageBox::ActionRole);
    QPushButton *addButton = msgBox.addButton("Add to Existing", QMessageBox::ActionRole);
    ...
    if (!clearExisting) {
        for (int row = 0; row < m_characterHotkeysTable->rowCount(); ++row) {
            QLineEdit *nameEdit = qobject_cast<QLineEdit*>(m_characterHotkeysTable->cellWidget(row, 0));
    ...
    if (addedCount > 0) {
        QMessageBox::information(this, "Characters Added", 
...
void ConfigDialog::onEditCycleGroupCharacters()
{
    ...
    QLabel *infoLabel = new QLabel("Add characters to this cycle group. Drag to reorder:");
    ...
    connect(populateButton, &QPushButton::clicked, [=]() {
        ...
        if (windows.isEmpty()) {
            QMessageBox::information(const_cast<ConfigDialog*>(this), "No Windows Found", 
                "No EVE Online windows are currently open.");
            return;
        }
        ...
        if (addedCount > 0) {
            QMessageBox::information(const_cast<ConfigDialog*>(this), "Characters Added", 
                QString("Added %1 character%2 to the list.")
                .arg(addedCount)
                .arg(addedCount == 1 ? "" : "s"));
        } else {
            QMessageBox::information(const_cast<ConfigDialog*>(this), "No New Characters", 
...
void ConfigDialog::onAddNeverMinimizeCharacter()
{
    ...
    connect(deleteButton, &QPushButton::clicked, this, [this, row]() {
        m_neverMinimizeTable->removeRow(row);
    });
...
void ConfigDialog::onAddCharacterColor()
{
    ...
    connect(colorButton, &QPushButton::clicked, this, &ConfigDialog::onCharacterColorButtonClicked);
    ...
    connect(deleteButton, &QPushButton::clicked, this, [this, row]() {
        m_characterColorsTable->removeRow(row);
    });
...
void ConfigDialog::onPopulateCharacterColors()
{
    ...
    if (!clearExisting) {
        for (int row = 0; row < m_characterColorsTable->rowCount(); ++row) {
            QLineEdit *nameEdit = qobject_cast<QLineEdit*>(m_characterColorsTable->cellWidget(row, 0));
            if (nameEdit && !nameEdit->text().trimmed().isEmpty()) {
                existingCharacters.insert(nameEdit->text().trimmed());
            }
        }
...
void ConfigDialog::onCharacterColorButtonClicked()
{
    ...
    QColor newColor = QColorDialog::getColor(currentColor, this, "Select Character Highlight Color");
...
void ConfigDialog::onAssignUniqueColors()
{
    ...
    if (rowCount == 0) {
        QMessageBox::information(this, "No Characters", 
            "There are no characters in the table. Add characters first using 'Add Character' or 'Populate from Open Clients'.");
        return;
    }
    
    QStringList colorPalette = {
        "#FF5733", "#A23E48", "#33FF57", "#F79F1F", "#3357FF", "#129C95", "#FF33A1", "#4C5B72",
        "#33FFF3", "#E8D42A", "#A133FF", "#5E2C00", "#57FF33", "#C38D9E", "#FFD133", "#1E4D2B",
        "#33A1FF", "#8F45A4", "#FF3357", "#2D005E", "#7A33FF", "#C4DFE6", "#FF7A33", "#5D5C61",
        "#33FF7A", "#F5B994", "#7A33FF", "#4B0002", "#337AFF", "#808000", "#FF337A", "#D8A47F",
        "#FF33D1", "#0A0A0A", "#D1FF33", "#FFFFFF", "#33D1FF", "#8B4513", "#D133FF", "#2F4F4F"
    };
    
    QMessageBox msgBox(this);
    msgBox.setWindowTitle("Assign Unique Colors");
    msgBox.setText(QString("This will assign unique colors to all %1 character%2 in the table.")
        .arg(rowCount)
        .arg(rowCount == 1 ? "" : "s"));
    msgBox.setInformativeText("Colors will be assigned from a predefined palette. Do you want to continue?");
    ...
    QMessageBox::information(this, "Colors Assigned", 
...
void ConfigDialog::onAddProcessName()
{
    ...
    connect(deleteButton, &QPushButton::clicked, this, [this, row]() {
        m_processNamesTable->removeRow(row);
    });
...
void ConfigDialog::onPopulateProcessNames()
{
    ...
    if (processToTitle.isEmpty()) {
        QMessageBox::information(this, "No Processes Found", 
    ...
    QLabel *infoLabel = new QLabel(QString("Found %1 unique process%2. Select the ones you want to monitor:")
    ...
    tableWidget->setHorizontalHeaderLabels({"Process Name", "Example Window Title"});
    ...
    for (auto it = processToTitle.constBegin(); it != processToTitle.constEnd(); ++it) {
    ...
    connect(selectAllButton, &QPushButton::clicked, tableWidget, &QTableWidget::selectAll);
    connect(clearSelectionButton, &QPushButton::clicked, tableWidget, &QTableWidget::clearSelection);
    connect(okButton, &QPushButton::clicked, &dialog, &QDialog::accept);
    connect(cancelButton, &QPushButton::clicked, &dialog, &QDialog::reject);
    ...
    if (dialog.exec() == QDialog::Accepted) {
        ...
        if (addedCount > 0) {
            QMessageBox::information(this, "Processes Added", 
                QString("Added %1 process name%2 to the Extra Previews list.")
                .arg(addedCount)
                .arg(addedCount == 1 ? "" : "s"));
        } else {
            QMessageBox::information(this, "No New Processes", 
    ...
    for (int pageIndex = 0; pageIndex < m_stackedWidget->count(); ++pageIndex) {
        ...
        for (QWidget* section : sections) {
            ...
            if (lowerSearch.isEmpty()) {
                ...
                QStringList keywords = section->property("searchKeywords").toStringList();
        ...
        if (pageIndex < m_categoryList->count()) {
            if (lowerSearch.isEmpty()) {
                ...
                if (pageHasVisibleSection && m_stackedWidget->currentIndex() != pageIndex) {
                    QWidget* currentPage = m_stackedWidget->currentWidget();
                    QList<QWidget*> currentSections = currentPage->findChildren<QWidget*>();
...
void ConfigDialog::onResetAppearanceDefaults()
{
    ...
    msgBox.setText("Are you sure you want to reset all appearance settings to their default values?");
    msgBox.setInformativeText("This will reset thumbnail size, opacity, highlighting, and overlay settings.");
    ...
    if (msgBox.exec() == QMessageBox::Yes) {
        ...
        m_highlightBorderWidthSpin->setValue(Config::DEFAULT_UI_HIGHLIGHT_BORDER_WIDTH);
        
        m_showCharacterNameCheck->setChecked(Config::DEFAULT_OVERLAY_SHOW_CHARACTER);
        ...
        m_characterNamePositionCombo->setCurrentIndex(Config::DEFAULT_OVERLAY_CHARACTER_POSITION); 
    Config::instance().setCharacterNameFont(QFont(Config::DEFAULT_OVERLAY_FONT_FAMILY, Config::DEFAULT_OVERLAY_FONT_SIZE));
        ...
        m_systemNamePositionCombo->setCurrentIndex(Config::DEFAULT_OVERLAY_SYSTEM_POSITION); 
    Config::instance().setSystemNameFont(QFont(Config::DEFAULT_OVERLAY_FONT_FAMILY, Config::DEFAULT_OVERLAY_FONT_SIZE));
        ...
        m_backgroundOpacitySpin->setValue(Config::DEFAULT_OVERLAY_BACKGROUND_OPACITY);
...
void ConfigDialog::onResetHotkeysDefaults()
{
    ...
    msgBox.setText("Are you sure you want to reset all hotkey settings to their default values?");
    msgBox.setInformativeText("This will clear all character hotkeys and cycle groups.");
    msgBox.setStandardButtons(QMessageBox::Yes | QMessageBox::No);
    msgBox.setDefaultButton(QMessageBox::No);
    msgBox.setStyleSheet(StyleSheet::getMessageBoxStyleSheet());
...
void ConfigDialog::onResetBehaviorDefaults()
{
    ...
    msgBox.setText("Are you sure you want to reset all behavior settings to their default values?");
    msgBox.setInformativeText("This will reset window management and positioning settings.");
    msgBox.setStandardButtons(QMessageBox::Yes | QMessageBox::No);
    msgBox.setDefaultButton(QMessageBox::No);
    msgBox.setStyleSheet(StyleSheet::getMessageBoxStyleSheet());
...
void ConfigDialog::onResetPerformanceDefaults()
{
    ...
    msgBox.setText("Are you sure you want to reset all performance settings to their default values?");
    msgBox.setInformativeText("This will reset the refresh interval settings.");
    msgBox.setStandardButtons(QMessageBox::Yes | QMessageBox::No);
    msgBox.setDefaultButton(QMessageBox::No);
    msgBox.setStyleSheet(StyleSheet::getMessageBoxStyleSheet());
...
void ConfigDialog::onResetCombatMessagesDefaults()
{
    ...
    msgBox.setText("Are you sure you want to reset all combat event messages settings to their default values?");
    msgBox.setInformativeText("This will reset position, font, event types, colors, durations, and mining timeout.");
    msgBox.setStandardButtons(QMessageBox::Yes | QMessageBox::No);
    msgBox.setDefaultButton(QMessageBox::No);
    msgBox.setStyleSheet(StyleSheet::getMessageBoxStyleSheet());
    
    if (msgBox.exec() == QMessageBox::Yes) {
        m_showCombatMessagesCheck->setChecked(Config::DEFAULT_COMBAT_MESSAGES_ENABLED);
        
        m_combatMessagePositionCombo->setCurrentIndex(Config::DEFAULT_COMBAT_MESSAGE_POSITION);
        
        Config::instance().setCombatMessageFont(QFont(Config::DEFAULT_OVERLAY_FONT_FAMILY, Config::DEFAULT_OVERLAY_FONT_SIZE));
        ...
        for (auto it = m_eventColorButtons.constBegin(); it != m_eventColorButtons.constEnd(); ++it) {
            ...
            if (eventType == "fleet_invite") checkbox = m_combatEventFleetInviteCheck;
            else if (eventType == "follow_warp") checkbox = m_combatEventFollowWarpCheck;
            else if (eventType == "regroup") checkbox = m_combatEventRegroupCheck;
            else if (eventType == "compression") checkbox = m_combatEventCompressionCheck;
            else if (eventType == "mining_started") checkbox = m_combatEventMiningStartCheck;
            else if (eventType == "mining_stopped") checkbox = m_combatEventMiningStopCheck;
            ...
            if (m_eventDurationSpins.contains(eventType)) {
                m_eventDurationSpins[eventType]->setValue(Config::DEFAULT_COMBAT_MESSAGE_DURATION / 1000);
            }
            
            if (m_eventBorderCheckBoxes.contains(eventType)) {
                m_eventBorderCheckBoxes[eventType]->setChecked(Config::DEFAULT_COMBAT_EVENT_BORDER_HIGHLIGHT);
            }
        }
...
void ConfigDialog::parseEVEXPreviewFile(const QVariantMap& rootMap)
{
    ...
    if (profiles.isEmpty()) {
        QMessageBox::warning(this, "Error", "No profiles found in EVE-X-Preview file.");
        return;
    }
    ...
    QLabel *headerLabel = new QLabel(QString("Found %1 EVE-X-Preview Profile(s)").arg(profiles.size()));
    headerLabel->setStyleSheet(StyleSheet::getSectionHeaderStyleSheet());
    headerLayout->addWidget(headerLabel);
    
    QLabel *infoLabel = new QLabel(
        "Select a profile to view its settings. You can then copy individual settings categories to your current profile."
    );
    ...
    selectLabel->setStyleSheet("color: #b0b0b0; font-size: 10pt; font-weight: bold;");
    ...
    connect(profileCombo, QOverload<int>::of(&QComboBox::currentIndexChanged), this, [this, profileCombo, settingsContainer]() {
...
void ConfigDialog::displayEVEXProfile(const QString& profileName, QWidget* container)
{
    ...
    if (profile.contains("Thumbnail Settings")) {
        ...
        if (thumbSettings.contains("ShowThumbnailsAlwaysOnTop")) {
            m_legacySettings["ShowThumbnailsAlwaysOnTop"] = thumbSettings["ShowThumbnailsAlwaysOnTop"];
        }
        
        if (thumbSettings.contains("ShowClientHighlightBorder")) {
            m_legacySettings["EnableActiveClientHighlight"] = thumbSettings["ShowClientHighlightBorder"];
        }
        
        if (thumbSettings.contains("ClientHighligtColor")) {
            m_legacySettings["ActiveClientHighlightColor"] = thumbSettings["ClientHighligtColor"];
        }
        
        if (thumbSettings.contains("ClientHighligtBorderthickness")) {
            m_legacySettings["ActiveClientHighlightThickness"] = thumbSettings["ClientHighligtBorderthickness"];
        }
        
        if (thumbSettings.contains("ShowThumbnailTextOverlay")) {
            m_legacySettings["ShowThumbnailOverlays"] = thumbSettings["ShowThumbnailTextOverlay"];
        }
        
        if (thumbSettings.contains("ThumbnailTextColor")) {
            m_legacySettings["OverlayLabelColor"] = thumbSettings["ThumbnailTextColor"];
        }
        ...
        if (thumbSettings.contains("HideThumbnailsOnLostFocus")) {
            m_legacySettings["HideThumbnailsOnLostFocus"] = thumbSettings["HideThumbnailsOnLostFocus"];
        }
    }
    ...
    if (profile.contains("Client Settings")) {
        ...
        if (clientSettings.contains("MinimizeInactiveClients")) {
            m_legacySettings["MinimizeInactiveClients"] = clientSettings["MinimizeInactiveClients"];
        }
    }
    ...
    if (profile.contains("Hotkey Groups")) {
        ...
        for (auto it = hotkeyGroups.constBegin(); it != hotkeyGroups.constEnd(); ++it) {
            if (groupIndex > 5) break;  
            ...
            if (group.contains("ForwardsHotkey")) {
                ...
                if (!hotkey.isEmpty()) {
                    m_legacySettings[QString("CycleGroup%1ForwardHotkeys").arg(groupIndex)] = 
                        QVariantList() << hotkey;
                }
            }
            ...
            if (group.contains("BackwardsHotkey")) {
                ...
                if (!hotkey.isEmpty()) {
                    m_legacySettings[QString("CycleGroup%1BackwardHotkeys").arg(groupIndex)] = 
                        QVariantList() << hotkey;
                }
            }
            ...
            if (group.contains("Characters")) {
                ...
                if (!clientsOrder.isEmpty()) {
                    m_legacySettings[QString("CycleGroup%1ClientsOrder").arg(groupIndex)] = clientsOrder;
                }
            }
    ...
    if (m_evexGlobalSettings.contains("ThumbnailSnap")) {
        m_legacySettings["EnableThumbnailSnap"] = m_evexGlobalSettings["ThumbnailSnap"];
    }
...
QWidget* ConfigDialog::createLegacyCategoryWidget(const QString& categoryName, const QVariantMap& settings)
{
    ...
    friendlyNames["ThumbnailRefreshPeriod"] = "Refresh Interval";
    ...
    connect(copyButton, &QPushButton::clicked, this, [this, categoryName, settings, copyButton]() {
...
void ConfigDialog::copyLegacySettings(const QString& category, const QVariantMap& settings)
{
    Config& config = Config::instance();
    ...
    if (category == "Thumbnail Settings") {
        ...
        if (settings.contains("ShowThumbnailsAlwaysOnTop")) {
            m_alwaysOnTopCheck->setChecked(settings["ShowThumbnailsAlwaysOnTop"].toBool());
        }
        
        if (settings.contains("MinimizeInactiveClients")) {
            m_minimizeInactiveCheck->setChecked(settings["MinimizeInactiveClients"].toBool());
        }
        
        if (settings.contains("HideActiveClientThumbnail")) {
            m_hideActiveClientThumbnailCheck->setChecked(settings["HideActiveClientThumbnail"].toBool());
        }
        ...
        if (settings.contains("ShowThumbnailOverlays")) {
            m_showCharacterNameCheck->setChecked(settings["ShowThumbnailOverlays"].toBool());
        }
        ...
        if (settings.contains("EnableActiveClientHighlight")) {
            m_highlightActiveCheck->setChecked(settings["EnableActiveClientHighlight"].toBool());
        }
        ...
        if (settings.contains("ActiveClientHighlightThickness")) {
            m_highlightBorderWidthSpin->setValue(settings["ActiveClientHighlightThickness"].toInt());
        }
    }
    else if (category == "Position & Snapping") {
        if (settings.contains("EnableThumbnailSnap")) {
            m_enableSnappingCheck->setChecked(settings["EnableThumbnailSnap"].toBool());
        }
        
        if (settings.contains("LockThumbnailLocation")) {
            m_lockPositionsCheck->setChecked(settings["LockThumbnailLocation"].toBool());
        }
        
        if (settings.contains("ThumbnailSnapToGridSizeX") && settings.contains("ThumbnailSnapToGridSizeY")) {
        ...
        auto legacyKeyToVirtualKey = [](const QString& keyName) -> int {
            ...
            if (key == "PAGEUP" || key == "PAGE UP") return VK_PRIOR;
            if (key == "PAGEDOWN" || key == "PAGE DOWN") return VK_NEXT;
            if (key == "PAUSE") return VK_PAUSE;
            if (key == "SCROLLLOCK" || key == "SCROLL LOCK") return VK_SCROLL;
        ...
        for (int i = 1; i <= 5; ++i) {
            ...
            QPushButton *charactersButton = new QPushButton(
                QString("(%1 characters)").arg(characterList.size())
            );
            charactersButton->setStyleSheet(StyleSheet::getTableCellButtonStyleSheet());
            charactersButton->setCursor(Qt::PointingHandCursor);
            ...
            includeNotLoggedInCheck->setChecked(false);
            includeNotLoggedInCheck->setToolTip("Include not-logged-in EVE clients in this cycle group");
            includeNotLoggedInCheck->setStyleSheet(StyleSheet::getDialogCheckBoxStyleSheet());
...
void ConfigDialog::showFeedback(QWidget* nearWidget, const QString& message)
{
    ...
    connect(animation, &QPropertyAnimation::finished, feedbackLabel, &QLabel::deleteLater);
...
void ConfigDialog::createProfileToolbar()
{
    ...
    connect(m_newProfileButton, &QPushButton::clicked, this, &ConfigDialog::onNewProfile);
    ...
    connect(m_cloneProfileButton, &QPushButton::clicked, this, &ConfigDialog::onCloneProfile);
    toolbarLayout->addWidget(m_cloneProfileButton);
    
    m_renameProfileButton = new QPushButton("Rename");
    m_renameProfileButton->setStyleSheet(StyleSheet::getProfileButtonStyleSheet());
    ...
    connect(m_renameProfileButton, &QPushButton::clicked, this, &ConfigDialog::onRenameProfile);
    toolbarLayout->addWidget(m_renameProfileButton);
    
    m_deleteProfileButton = new QPushButton("Delete");
    m_deleteProfileButton->setStyleSheet(StyleSheet::getProfileDeleteButtonStyleSheet());
    ...
    connect(m_deleteProfileButton, &QPushButton::clicked, this, &ConfigDialog::onDeleteProfile);
    ...
    m_profileHotkeyCapture->setStyleSheet(StyleSheet::getHotkeyCaptureStandaloneStyleSheet());
    connect(m_profileHotkeyCapture, &HotkeyCapture::hotkeyChanged, this, [this]() {
        QString currentProfile = Config::instance().getCurrentProfileName();
        ...
        int modifiers = 0;
        if (m_profileHotkeyCapture->getCtrl()) modifiers |= Qt::ControlModifier;
        if (m_profileHotkeyCapture->getAlt()) modifiers |= Qt::AltModifier;
        if (m_profileHotkeyCapture->getShift()) modifiers |= Qt::ShiftModifier;
        ...
        QString conflict = HotkeyManager::instance()->findHotkeyConflict(binding, currentProfile);
        if (!conflict.isEmpty()) {
            QMessageBox::warning(this, "Hotkey Conflict",
                QString("This hotkey is already assigned to:\n\n%1\n\nPlease choose a different hotkey or remove the existing assignment first.").arg(conflict));
    ...
    m_clearProfileHotkeyButton->setStyleSheet(StyleSheet::getProfileButtonStyleSheet());
...
void ConfigDialog::updateProfileDropdown()
{
    ...
    qDebug() << "Updating profile dropdown. Profiles:" << profiles << "Current:" << currentProfile;
...
{
    Config& config = Config::instance();
    QSettings globalSettings(config.configFilePath().replace(QRegularExpression("/profiles/.*\\.ini$"), "/settings.global.ini"), QSettings::IniFormat);
    
    bool skipConfirmation = globalSettings.value(Config::KEY_UI_SKIP_PROFILE_SWITCH_CONFIRMATION, Config::DEFAULT_UI_SKIP_PROFILE_SWITCH_CONFIRMATION).toBool();
    ...
    globalSettings.setValue(Config::KEY_UI_SKIP_PROFILE_SWITCH_CONFIRMATION, true);
        globalSettings.sync();
    }
...
void ConfigDialog::switchProfile(const QString& profileName)
{
    ...
    if (Config::instance().loadProfile(profileName)) {
        ...
        QMessageBox::warning(this, "Profile Switch Failed",
...
void ConfigDialog::onNewProfile()
{
    QTimer::singleShot(0, this, [this]() {
        ...
        bool success;
        if (reply == QMessageBox::Yes) {
            success = Config::instance().cloneProfile(Config::instance().getCurrentProfileName(), profileName);
        } else {
        ...
        if (success) {
            ...
            QMessageBox::StandardButton switchNow = QMessageBox::question(this,
                                                                          "Switch Profile?",
                                                                          QString("Profile \"%1\" created successfully.\n\n"
                                                                                 "Switch to it now?").arg(profileName),
                                                                          QMessageBox::Yes | QMessageBox::No);
...
void ConfigDialog::onCloneProfile()
{
    QTimer::singleShot(0, this, [this]() {
        ...
        bool ok;
        QString cloneName = QInputDialog::getText(this,
                                                 "Clone Profile",
                                                 QString("Clone \"%1\" as:").arg(currentProfile),
                                                 QLineEdit::Normal,
                                                 defaultName,
                                                 &ok);
        ...
        if (cloneName.contains('/') || cloneName.contains('\\') || cloneName.contains('.')) {
            QMessageBox::warning(this, "Invalid Name",
                               "Profile name cannot contain slashes or dots.");
            return;
        }
        ...
        if (Config::instance().cloneProfile(currentProfile, cloneName)) {
            ...
            QMessageBox::information(this, "Profile Cloned",
                                   QString("Profile \"%1\" cloned successfully as \"%2\".")
                                   .arg(currentProfile).arg(cloneName));
    ...
    QTimer::singleShot(0, this, [this]() {
        ...
        if (Config::instance().renameProfile(currentProfile, newName)) {
            ...
            QMessageBox::information(this, "Profile Renamed",
                                   ...
                                   .arg(currentProfile).arg(newName));
        } else {
